# na aula do dia 02/10 foi pedido para criar um arquivo que possuisse todas as funcionalidades pedidas até então
#
# rodar a main do arquivo funcionalidades_db/main.py usando o comando: python3 main.py
